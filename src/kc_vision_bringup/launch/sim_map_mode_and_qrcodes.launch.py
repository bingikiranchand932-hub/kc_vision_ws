...
Importantly, this launch file also runs the 'qr_code_reader' node from the 'kc_vision_scripts' package
...
def generate_launch_description():
    ...
    # =========== Run the 'qr_code_reader.py' node (in 'kc_vision_scripts') ============ #

    start_qr_reader_cmd = Node(
    package='kc_vision_scripts',
